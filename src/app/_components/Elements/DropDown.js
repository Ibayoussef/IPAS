    ...
    return (
        <>
            <div 
                ...
                className={`cursor-pointer flex flex-row items-center justify-between ${open ? 'border-b-0' : 'border-b'} first:border-t border-secondary`}
            >
                ...
                >
                    <svg width="2rem" height="2.1rem" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">

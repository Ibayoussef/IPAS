...
const Pricing = ({ data }) => {
    ...
    return (
        <div id='Pricing' className='bg-[#E7E1D8] px-5 sm:px-16 py-48 '>
            ...
            <div className='flex flex-row flex-wrap justify-between w-full h-full'>
                {prices.thead.map((price, index) => <div className='px-8 mt-16 border-l w-full sm:w-[25rem] first:border-0 border-[#AA9A8166]' key={price.value}>

...
function Testimonials({ data }) {
    ...
    return (
        <div id='Testimonials' className='relative flex flex-col items-center justify-center w-full h-full px-64 text-center py-28'>
            ...
            <div className='w-[50%] mt-36 flex flex-row items-center gap-8 relative'>
                <svg className='absolute -right-[50px] -top-1/2' width="10rem" height="10rem" viewBox="0 0 160 127" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M159.379 97.457C159.379 106.194 156.122 113.342 149.609 118.902C143.255 124.303 136.027 127.004 127.926 127.004C115.694 127.004 105.607 122.318 97.6641 112.945C89.8803 103.573 85.9883 92.1354 85.9883 78.6328C85.9883 58.2995 91.8659 41.6992 103.621 28.832C115.376 15.9648 131.023 6.51302 150.563 0.476562V10.2461C138.648 16.2826 128.641 24.0664 120.539 33.5977C112.596 42.9701 108.625 52.5013 108.625 62.1914C108.625 64.5742 109.102 67.1159 110.055 69.8164C111.008 72.5169 112.994 73.8672 116.012 73.8672C118.553 73.8672 121.095 73.2318 123.637 71.9609C126.178 70.5312 129.514 69.8164 133.645 69.8164C140.793 69.8164 146.829 72.5964 151.754 78.1562C156.837 83.5573 159.379 89.9909 159.379 97.457ZM73.629 97.2188C73.629 105.797 70.3725 112.866 63.8594 118.426C57.3464 123.986 49.8803 126.766 41.461 126.766C29.3881 126.766 19.4597 122.079 11.6758 112.707C3.89199 103.335 6.10352e-05 91.9766 6.10352e-05 78.6328C6.10352e-05 58.1406 5.87767 41.4609 17.6329 28.5938C29.3881 15.7266 44.9558 6.19531 64.336 0V10.0078C52.2631 15.8854 42.3347 23.5898 34.5508 33.1211C26.767 42.6523 22.8751 52.263 22.8751 61.9531C22.8751 64.4948 23.2722 67.1159 24.0665 69.8164C24.8607 72.5169 26.9258 73.8672 30.2618 73.8672C32.8034 73.8672 35.3451 73.1523 37.8868 71.7227C40.4284 70.293 43.7644 69.5781 47.8946 69.5781C55.2019 69.5781 61.3178 72.3581 66.2422 77.918C71.1667 83.319 73.629 89.7526 73.629 97.2188Z" fill="#AA9A81" />
                </svg>
                <svg ref={prevRef} className='cursor-pointer arrow-left' width="55" height="53" viewBox="0 0 55 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="54.2559" y="52.4218" width="53.6776" height="51.8434" rx="25.9217" transform="rotate(180 54.2559 52.4218)" stroke="#AA9A81" stroke-width="1.1565" />
                    <path d="M36.33 27.6565L22.9309 27.6565L28.1351 32.8608L26.4998 34.4961L18.5038 26.5L26.4998 18.504L28.1351 20.1393L22.9309 25.3435L36.33 25.3435L36.33 27.6565Z" fill="#AA9A81" />
                </svg>
                ...
                <svg ref={nextRef} className='cursor-pointer arrow-right' width="55" height="53" viewBox="0 0 55 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.578248" y="0.578248" width="53.6776" height="51.8434" rx="25.9217" stroke="#AA9A81" stroke-width="1.1565" />
                    <path d="M18.504 25.3435L31.9031 25.3435L26.6989 20.1392L28.3342 18.5039L36.3302 26.5L28.3342 34.496L26.6989 32.8607L31.9031 27.6565L18.504 27.6565L18.504 25.3435Z" fill="#AA9A81" />
                </svg>

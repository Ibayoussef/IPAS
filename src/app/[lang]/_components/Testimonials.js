...
function Testimonials({ data }) {
    ...
    return (
        <div id='Testimonials' className='relative flex flex-col items-center justify-center w-full h-full px-4 text-center lg:px-64 py-28'>
            ...
            <div className='w-full lg:w-[50%] mt-36 flex flex-row items-center gap-8 relative'>
                <svg className='absolute right-4 lg:-right-[50px] -top-1/2' width="10rem" height="10rem" viewBox="0 0 160 127" fill="none" xmlns="http://www.w3.org/2000/svg">
